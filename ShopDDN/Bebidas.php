...
<body>
    ...
    <main id="principal">
    <h1 class="heading" id = "titulo"> Nossas <span>Bebidas</span> </h1>
        <div id="cards">
           <?php foreach($sql as $bebidas) :?>
            <?php
                verificarBebidas($conexao, $bebidas['Validade'], $bebidas['Codigo']);
                // VERIFICAR VALIDADE DOS PRODUTOS DE TABELA[BEBIDAS]

            ?>
                    <div id = 'card'>
                        <div id = "div-imagem">
                            <img id = 'card-imagem' src='img/<?php echo $bebidas['Imagem']?>' alt="Imagem do produto">
                        </div>
                    <p id = 'card-text'>
                        Produto : <?php echo $bebidas['Produto']?><br>
                        Descrição : <?php echo $bebidas['Descricao']?><br>
                        Preço : <?php echo $bebidas['Preco']?>MT<br>
                    </p> 
                        <small id = 'val'>
                            Validade : <?php echo $bebidas['Validade']?>
                        </small>
                    <div id = 'div-btn-comprar'>
                        <button onclick = 'mostrar()' class = "btn-comprar view_data" id = <?php echo $bebidas['ID']?>>Comprar</button>
                    </div >
        ...
        <div class="popup" id="popup">
            <div class="popup-content">
                ...
                <!-- FORMULARIO DE PAGAMENTO -->
                    ...
                    <input type="hidden" name = "ctg" value = "Bebidas">
                    <!-- INPUT HIDDEN QUE RECEBE O COGIGO[Chave Primaria] -->
    ...
    <div class="foot-container">
        ...
        <div class="foot">
            ...
            <a href="Produtos.php" class="links"> <i class="fas fa-arrow-right"></i> Categorias </a>
    ...
    <div class="foot reclamacao">
        ...
        <form action="https://formsubmit.co/9ae7d72953c1e3c663a867e4b34a19e9" method="POST" class="needs-validation" novalidate>
            ...
            <input type="hidden" name="_next" value="http://localhost/Bebidas.php">
