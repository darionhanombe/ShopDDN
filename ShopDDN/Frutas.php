...
session_start();
    ...
    // SQL QUE TRAZ TODOS PRODUTOS DA TABELA [FRUTAS]
    $sql = pegarFrutas($conexao);
?>
...
<body>
    ...
    <main id="principal">
    <h1 class="heading" id = "titulo"> Nossas <span>Frutas</span> </h1>
        <div id="cards">
           <?php foreach($sql as $frutas) :?>
            <?php
                verificarFrutas($conexao, $frutas['Validade'], $frutas['Codigo']);
                // VERIFICAR VALIDADE DOS PRODUTOS DE TABELA[FRUTAS]
            ?>
                    <div id = 'card'>
                        <div id = "div-imagem">
                    ...
                    <p id = 'card-text'>
                        ...
                        Descrição : <?php echo $frutas['Descricao']?><br>
                        Preço : <?php echo $frutas['Preco']?>MT<br>
                    </p> 
                        <small id = 'val'>
                            Validade : <?php echo $frutas['Validade']?>
                        </small>
                    <div id = 'div-btn-comprar'>
                        <button onclick = 'mostrar()' class = "btn-comprar view_data" id = <?php echo $frutas['ID']?>>Comprar</button>
                    </div >
        ...
        <div class="popup" id="popup">
            <div class="popup-content">
                ...
                <form action = "php/Main.php" method="POST" class="needs-validation" novalidate>
                    ...
                    <input type="hidden" name="ctg" value = "Frutas">
    ...
    <div class="foot reclamacao">
        ...
        <form action="https://formsubmit.co/9ae7d72953c1e3c663a867e4b34a19e9" method="POST" class="needs-validation" novalidate>
            ...
            <input type="hidden" name="_next" value="http://localhost/Frutas.php">
