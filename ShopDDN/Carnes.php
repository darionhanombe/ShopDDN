...
session_start();
    ...
    // SQL QUE TRAZ TODOS PRODUTOS DA TABELA [CARNES]
    $sql = pegarCarnes($conexao);
?>
...
<body>
    ...
    <main id="principal">
    <h1 class="heading" id = "titulo"> Nossas <span>Carnes</span> </h1>
        <div id="cards">
           <?php foreach($sql as $carnes) :?>
            <?php
                verificarCarnes($conexao, $carnes['Validade'], $carnes['Codigo']);
                // VERIFICAR VALIDADE DOS PRODUTOS DE TABELA[CARNES]
            ?>
                    <div id = 'card'>
                        <div id = "div-imagem">
                    ...
                    <div id = 'div-btn-comprar'>
                        <button onclick = 'mostrar()' class = "btn-comprar view_data" id = <?php echo $carnes['ID']?>>Comprar</button>
                    </div >
        ...
        <div class="popup" id="popup">
            <div class="popup-content">
                ...
                <!-- FORMULARIO DE PAGAMENTO -->
                    ...
                    <input type="hidden" name="ctg" value = "Carnes">
    ...
    <div class="foot-container">
        ...
        <div class="foot">
            ...
            <a href="#catg" class="links"> <i class="fas fa-arrow-right"></i> Categorias </a>
